...
const helpSections = [
    ...
    items: [
      {
        ...
        description:
          "في صفحة الألحان، اضغط على أحد أزرار المراحل الدراسية: حضانة، أولى و ثانية، ثالثة و رابعة، خامسة و سادسة، إعدادي، ثانوي، جامعة، خدام وخادمات، أو عرس قانا الجليل",
      },
      {
  ...
  {
    title: "٢. البرنامج التمهيدي (طقس الألحان)",
    icon: FaBookOpen,
    items: [
      {
        label: "ما هو البرنامج التمهيدي؟",
        description:
          "هو برنامج يضم ألحاناً مخففة مخصصة للقرى الناشئة في الإيبارشية، لتبسيط عملية التعلم والحفظ.",
      },
      {
        label: "تقسيم المراحل في التمهيدي",
        description:
          "ينقسم البرنامج التمهيدي إلى أربع فئات: (حضانة)، (أولى وثانية وثالثة)، (رابعة وخامسة وسادسة)، و(إعدادي وثانوي).",
      },
      {
        label: "طقس الألحان",
        description:
          "يتوفر شرح الطقس والمعاني لمرحلتي: (رابعة وخامسة وسادسة) و(إعدادي وثانوي) فقط داخل البرنامج التمهيدي.",
      },
      {
        label: "التبديل بين الفيديوهات والطقس",
        description:
          "بعد اختيار المرحلة، ستظهر لك أزرار التبديل في منتصف الصفحة أسفل أسماء المراحل مباشرة، حيث يمكنك الاختيار بين 'فيديوهات الألحان' أو 'طقس الألحان'.",
      },
    ],
  },
  {
    title: "٣. لوحة الإعدادات",
  ...
  },
  {
    ...
    items: [
      {
        label: "ظهور الهزات تلقائياً",
        description:
          "صور الهزات تظهر تلقائياً أسفل الكلمات داخل نافذة اللحن عند توفرها",
      },
    ],
  },
  {
    title: "٧. تدوير الشاشة",
    icon: FaRedo,
    items: [
      {
  ...
  {
    title: "١٠. العمل بدون إنترنت (التخزين المحلي)",
    icon: FaWifi,
    items: [
      {
        label: "الفكرة",
