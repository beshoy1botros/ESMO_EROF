...
const videoData: VideoData = {
    ...
    first: [
      {
        ...
        url: "/مقدمة الذكصولوجيات الكيهكي.mp4",
        copticArabic:
    ...
    first: [
      {
        id: "fs1-1",
        title:
          "أرباع الناقوس لشهر كيهك (شيرى غابرييل بى نيشتى إن أرشى أنجيلوس + شيري في ايطاف هي + شيرى يؤانس)",
    ...
    gifted: [
      {
        id: "fsg-1",
        title:
          "مقدمة الذكصولوجيات بالنغمة الكيهكي كاملة (بختام اخر ربعين بالطريقه الكبيرة)",
        ...
        hazzatImage: "/مقدمة الذكصولوجيات الكيهكي.png",
      },
      {
        id: "fsg-2",
    ...
    second: [
      {
        ...
        hazzatImage: "/شيريه نيه ماريا خين اوشيريه افؤواب.png",
      },
      {
        id: "tf2-2",
      ...
      {
        id: "tf2-4",
        title: "مرد الإنجيل الأحد الأول لشهر كيهك (آاباشويس أوأرب إن غابرييل)",
    ...
    gifted: [
      {
        ...
        hazzatImage: "/تين اوويه انسوك.jpg",
        hazzatImage2: "/تين اوويه انسوك (2).jpg",
        hazzatImage3: "/تين اوويه انسوك(3).jpg",
      },
      {
        id: "tfg-2",
  ...
  [StageKey.FifthSixth]: {
    first: [
      ...
      {
        id: "5s1-3",
        title: "مرد الابركسيس لشهر كيهك (شيري غابرييل بي فاي شنوفي)",
        ...
        hazzatImage: "/شيريه غابرييل بي فاي شينوفي.png",
      },
      {
        id: "5s1-4",
        title:
          "هتينيات شهر كيهك كاملة (الملاك غبريال المبشر + يوحنا المعمدان نسيب عمانوئيل + الكاهن زكريا واليصابات + يواقيم وحنه)",
    ...
    second: [
      ...
      },
      {
        ...
        hazzatImage: "/سوتيم طاشيري.png",
        hazzatImage2: "/سوتيم طاشيري 2.png",
      },
      {
        id: "5s2-3",
    ...
    gifted: [
      {
        ...
        hazzatImage: "/اف امبشا1.png",
        hazzatImage2: "/اف امبشا2.png",
        hazzatImage3: "/اف امبشا3.png",
      },
      {
        id: "5sg-2",
        ...
        hazzatImage: "/شيريه نيه ماريا تسبحة1.png",
        hazzatImage2: "/شيريه نيه ماريا تسبحة2.png",
      },
    ],
  },
  [StageKey.Middle]: {
    first: [
      {
        id: "m1-1",
        title:
          "مرد الأبركسيس لشهر كيهك الأسبوع الأول والثاني (شيري غابرييل بي نيشتي ان ارشي + شيري غابرييل بي فاي شنوفي)",
        ...
        arabicTranslation:
          "السلام لغبريال ، رئيس الملائكة العظيم ، السلام للذى بشر ، مريم العذراء .\n\nالسلام لغبريال المبشر : العظيم في الملائكة : الطغمات المقدسة العلوية : حامل السيف الملتهب نارا  .",
        hazzatImage: "/شيريه غابرييل بي نيشتي.png",
      },
      {
        id: "m1-2",
    ...
    second: [
      {
        ...
        copticcoptic:
          "+ ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ϫⲉ ⲁⲕⲓ̀ⲣⲓ ⲛ̀ⲛⲓⲙⲁⲛ: Ⲕⲁⲧⲁ ⲡⲉⲕⲛⲓϣϯ ⲛ̀ⲛⲁⲓ.\n\n+ Ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ �
�ⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ϫⲉ ⲁⲕϣⲉⲛⲁⲕ ⲉ̀ⲡ̀ϣⲱⲓ: Ⲉ̀ⲛⲓⲫⲏⲟⲩⲒ̀.\n\n+ Ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ϫⲉ ⲁⲕϩⲉⲙⲥⲓ ⲥⲁⲟⲩⲒ̀ⲛⲁⲙ: Ⲙ̀Ⲡⲓⲡⲁⲛⲧ­ⲟⲕⲣⲁⲧⲱ­ⲣ.\n\n+ Ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ϫⲉ ⲉⲕⲉ̀ⲓ̀ ⲉ̀ϯϩⲁⲡ: Ⲉ̀ϯⲟⲓⲕⲟⲩ­ⲙⲉⲛⲏ.\n\n+ Ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ⲙⲟⲓ ⲛⲁⲛ ⲛ̀ⲟⲩⲛⲁⲓ: Ⲛⲉⲙ ⲟⲩⲭⲱ ⲉⲃⲟⲗ.\n\n+ Ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ⲁ̀ⲣⲓⲥⲩⲛⲭ­ⲱⲣⲓⲛ: Ⲛ̀ⲛⲉⲛⲡⲁⲣ­ⲁⲡⲧⲱⲙⲁ.\n\n+ Ϯϣⲉⲡϩ̀ⲙⲟⲧ ⲛ̀ⲧⲟⲧⲕ: Ⲫϯ ⲙ̀Ⲡⲓⲥ̅ⲗ̅: Ϯϯⲱⲟⲩ ⲙ̀ⲡⲉⲕⲣⲁⲛ ⲟⲩⲟϩ ⲧⲉⲛⲟⲩⲱ­ϣⲧ ⲙ̀ⲙⲟⲕ: Ⲕⲁⲧⲁ ⲡⲉⲕⲛⲓϣϯ ⲛ̀ⲛⲁⲓ.",
        arabicTranslation:
      ...
      },
      {
        ...
        hazzatImage: "/تينين1.png",
        hazzatImage2: "/تينين2.png",
        hazzatImage3: "/تينين3.png",
      },
      {
        id: "m2-3",
    ...
    gifted: [
      {
        ...
        hazzatImage: "/التوزيع الكيهكي.jpg",
        hazzatImage2: "/التوزيع الكيهكي5.jpg",
        hazzatImage3: "/التوزيع الكيهكي6.jpg",
      },
      {
        id: "mg-2",
      ...
      },
      {
        ...
        hazzatImage: "/سيموتي1.png",
        hazzatImage2: "/سيموتي2.png",
      },
    ],
  },
  [StageKey.High]: {
    ...
    second: [
      ...
      },
      {
        ...
        arabicTranslation:
          ...
          hazzatImage:"/اسمو ابتشويس1.png",
          hazzatImage2:"/اسمو ابتشويس2.png",
      },
      {
        id: "h2-4",
        title: "لحن افشيس",
        ...
        arabicTranslation:
          ...
          hazzatImage:"/افشيس1.png",
          hazzatImage2:"/افشيس2.png",
