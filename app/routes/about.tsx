    ...
    second: [
      {
        ...
        content:
          "يقال في تسبحة نصف الليل قبل المجمع وبعد تسبحة الثلاثة فتية(آريبصالين)، وبعد تينين في أيام شهر كيهك. / له ستة نغمات علي مدار السنة (سنوي - كيهكي - فرايحي - شعانيني - صيامي أيام - صيامي سبوت وآحاد). هذا المديح هو جزء من صلاة عزاريا التي صلاها بمفرده وهو مع حنانيا وميصائيل في وسط أتون النار والتي وردت في تتمة سفر دانيال (تتمة دانيال٢٤:٣_٤٥).",
      },
      {
