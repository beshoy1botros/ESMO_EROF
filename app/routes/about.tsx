    ...
    gifted: [
      {
        ...
        content:
          "يقال في تسبحة عشية مساء يوم السبت بعد صلاة الساعة (التاسعة والحادية عشر والثانية عشر) من المزامير وقبل الهوس الرابع/ يقال أيضا في تطيب رفات الشهداء والقديسين/ يقال أيضا في جنازات الآباء الكهنة والأساقفة والبطاركة.",
      },
      {
