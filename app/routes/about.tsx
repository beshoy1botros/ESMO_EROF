...
تقال ذكصولوجية الآباء الرسل بعد ذكصولوجية القديس يوحنا المعمدان وقبل ذكصولوجية القديس مار مرقس.`,
    ...
    second: [
      ...
      },
      {
        ...
        content:
          "هو تلخيص او اختصار لنغمة المزمور السنجاري (الفرايحي). يقال في قداسات الأعياد التي ليست فرايحي.",
      },
      {
        title: "طاي شوري السنوي",
        content:
    ...
    gifted: [
      {
        ...
        content: "يقال في صوم وأعياد السيدة العذراء مريم بعد التوزيع.",
      },
      {
  ...
  middle: {
    ...
    second: [
      ...
      },
      {
        ...
        content:
          "هو لبش الهوس الثالث يقال بعد الهوس الثالث وقبل تين اويه انسوك./كلمة لبش معناها: تفسير.",
      },
      {
    ...
    gifted: [
      {
        ...
        content:
          "يقال في تسبحة عشية مساء يوم السبت بعد صلاة الساعة (التاسعة والحادية عشر والثانية عشر) من المزامير.",
      },
      {
