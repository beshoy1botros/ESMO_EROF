    ...
    first: [
      {
        ...
        content: `ذكسولوجية: كلمة يونانية معناها: تمجيد بركة.

والذكسولوجيات هي قطع تقال في التسبحة بعد مجمع القديسين، وتقال في رفع بخور عشية وباكر بعد الأواشي التي تقال بعد صلاة الشكر. وتكون دائماً بلحن وأطس، وتقال بخمس طرق على مدار السنة وهي: (سنوي – فرايحي – صيامي – شعانيني – كيهكي). والذكسولوجيات عبارة عن تمجيدات للعذراء مريم والدة الإله، والملائكة، والرسل، والشهداء، والقديسين.

تقال ذكصولوجية الإباء الرسل بعد ذكصولوجية القديس يوحنا المعمدان وقبل ذكصولوجية القديس مار مرقس`,
      },
      {
