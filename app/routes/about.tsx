    ...
    second: [
      {
        ...
        content:
          "يقال في تسبحة نصف الليل قبل المجمع وبعد تسبحة الثلاثة فتية(آريبصالين)، وبعد تينين في أيام شهر كيهك. / له ستة نغمات علي مدار السنة (سنوي - كيهكي - فرايحي - شعانيني - صيامي أيام - صيامي سبوت وآحاد).",
      },
      {
