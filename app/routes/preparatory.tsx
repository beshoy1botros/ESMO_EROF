...
const preparatoryVideos: StageVideos = {
  ...
  "اولي وتانيه وثالثة": [
    {
      ...
      url: `${BASE_URL}/Owla_Tania-1-4.mp4`,
      copticArabic:
    ...
    },
    {
      ...
      url: `${BASE_URL}/Owla_Tania-1-3.mp4`,
      copticArabic:
  ...
  "رابعة وخامسة وسادسة": [
    ...
    },
    {
      ...
      url: `${BASE_URL}/Talta_Rabaa-1-1.mp4`,
      copticArabic:
    ...
    },
    {
      ...
      url: `${BASE_URL}/Khamsa_Satta-1-4.mp4`,
      copticArabic:
  ...
  "اعدادي وثانوي": [
    {
      id: "hs1",
      title: "لحن طاي شوري",
      url: `${BASE_URL}/Talta_Rabaa-2-2.mp4`,
      copticArabic:
                  ...
                  {showControlsPanel && (
                    ...
                    >
                      ...
                      >
                        ...
                        {hazzatImagesCount > 0 && (
                          <div className="rounded-xl border border-purple-500/20 bg-purple-500/10 px-4 py-2.5 text-xs font-bold text-purple-200 text-center leading-relaxed">
                            الهزات تظهر تلقائياً أسفل الكلمات عند توفرها
                          </div>
                        )}
