...
const preparatoryVideos: StageVideos = {
  حضانة: [
    {
      ...
      url: `${BASE_URL}/Hadana-1-4_gkkcss.mp4`,
      copticArabic:
    ...
    },
    {
      ...
      url: `${BASE_URL}/Hadana-2-1_sw4yc6.mp4`,
      copticArabic:
  ...
  "اولي وتانيه وثالثة": [
    ...
    },
    {
      ...
      url: `${BASE_URL}/Owla_tania-1-3_ndtdz9.mp4`,
      copticArabic:
  ...
  "رابعة وخامسة وسادسة": [
    {
      ...
      url: `${BASE_URL}/T_rabaa-1_wfjmsv.mp4`,
      copticArabic:
  ...
  "اعدادي وثانوي": [
    ...
    },
    {
      ...
      url: `${BASE_URL}/Phigh-3_by1zw6.mp4`,
      copticArabic:
