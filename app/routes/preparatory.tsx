...
const preparatoryTextContent: Record<string, TextContent[]> = {
  حضانة: [
    {
      id: "k-text1",
      title: "طقس اللحن الأول",
      content:
        "شرح طقس اللحن الأول للحضانة - يتضمن الأساسيات البسيطة للألحان القبطية المناسبة لهذا العمر.",
    },
    {
      id: "k-text2",
      title: "طقس اللحن الثاني",
      content:
        "شرح طقس اللحن الثاني للحضانة - يركز على الألحان التفاعلية والبسيطة.",
    },
    {
      id: "k-text3",
      title: "طقس اللحن الثالث",
      content:
        "شرح طقس اللحن الثالث للحضانة - يتضمن الألحان الاحتفالية المبسطة.",
    },
  ],
  "اولي وتانيه وثالثة": [
    {
      ...
      title: "طقس اللحن الأول",
      content:
        "شرح طقس اللحن الأول للمرحلة الابتدائية الأولى - يتضمن أساسيات الألحان والطقوس.",
    },
    {
      id: "p-text2",
      title: "طقس اللحن الثاني",
      content:
        "شرح طقس اللحن الثاني للمرحلة الابتدائية الأولى - يركز على الألحان الموسمية.",
    },
    {
      id: "p-text3",
      title: "طقس اللحن الثالث",
      content:
        "شرح طقس اللحن الثالث للمرحلة الابتدائية الأولى - يتضمن الألحان الاحتفالية.",
    },
  ],
  "رابعة وخامسة وسادسة": [
    {
      ...
      title: "طقس اللحن الأول",
      content:
        "شرح طقس اللحن الأول للمرحلة الابتدائية العليا - يتضمن الألحان المتقدمة والطقوس المفصلة.",
    },
    {
      id: "s-text2",
      title: "طقس اللحن الثاني",
      content:
        "شرح طقس اللحن الثاني للمرحلة الابتدائية العليا - يركز على الألحان الليتورجية.",
    },
    {
      id: "s-text3",
      title: "طقس اللحن الثالث",
      content:
        "شرح طقس اللحن الثالث للمرحلة الابتدائية العليا - يتضمن الألحان الخاصة بالأعياد.",
    },
  ],
  "اعدادي وثانوي": [
    {
      ...
      title: "طقس اللحن الأول",
      content:
        "شرح طقس اللحن الأول للمرحلة الإعدادية والثانوية - يتضمن الألحان المعقدة والطقوس المتقدمة.",
    },
    {
      id: "hs-text2",
      title: "طقس اللحن الثاني",
      content:
        "شرح طقس اللحن الثاني للمرحلة الإعدادية والثانوية - يركز على الألحان الكنسية المتقدمة.",
    },
    {
      id: "hs-text3",
      title: "طقس اللحن الثالث",
      content:
        "شرح طقس اللحن الثالث للمرحلة الإعدادية والثانوية - يتضمن الألحان الاحتفالية الكبرى.",
    },
    {
      id: "hs-text4",
      title: "طقس اللحن الرابع",
      content:
        "شرح طقس اللحن الرابع للمرحلة الإعدادية والثانوية - يتضمن الألحان الخاصة والطقوس المتخصصة.",
    },
  ],
};
