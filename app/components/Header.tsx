    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between py-3 sm:py-4">
            ...
            >
              ...
              <span className={`block w-5 h-0.5 bg-current rounded-full transition-all duration-200 my-[5px] ${isMenuOpen ? "opacity-0 scale-x-0" : ""}`} />
              <span className={`block w-5 h-0.5 bg-current rounded-full transition-all duration-300 origin-center ${isMenuOpen ? "-rotate-45 -translate-y-[7px]" : ""}`} />
            </button>

            {/* العنوان */}
            <Link to="/" className="flex-1 text-center group focus-visible:outline-none" aria-label="الصفحة الرئيسية">
              <h1 className="
            ...
            <Link to="/" tabIndex={-1}>
              <img
                ...
                height={48}
                className="
                  w-11 h-11 sm:w-14 sm:h-14 object-contain
          ...
          <nav className="hidden md:flex justify-center gap-1 pb-3" aria-label="القائمة الرئيسية">
      ...
      */}
      ...
      >
        ...
        {/* روابط التنقل */}
        <nav className="flex-1 overflow-y-auto py-4 px-3" aria-label="روابط الصفحات">
          {navLinks.map(({ to, label, icon: Icon }, index) => (
            ...
            >
              ...
              {isActive(to) && (
                <svg className="mr-auto text-blue-500" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
